...
INSERT INTO `exploring` VALUES (1,'desktop','Desktop','desktop','Chendito','Hacking','Texture','I will be rain - Bruno Mars | Cover','it-will-rain','bruno-mars','video 1'),(2,'documents','Documents','documents','Developer','History JavaScript','Math Fisc','More than words - Extreme','more-than-words','extreme','my page'),(3,'downloads','Downloads','downloads','Javascript','Php Master','Music Hack','Let it be - The Beatles | Cover','let-it-be','the-beatles',''),(4,'music','Music','music','Chatbot','Development','Entertainment','Foreigner I want to...','foreigner-i-want-to','foreigner',''),(5,'pictures','Pictures','pictures','chendito.com','Images Store','Source Code','Tears in heaven - Boyce A. | Cover','tears-in-heaven','boyce-avenue',''),(6,'videos','Videos','videos','Capture','Moda Devaechba','Full Stacks','Bee Gees - How deep is your love','bee-gees-how-deep-is-your-love','bee-gees',''),(7,'chendo_disk','Chendito C:','','','','','',NULL,'',''),(8,'chendo_disk','Chendo D:','','','','','',NULL,'','');
...
-- Dump completed on 2022-04-27 20:13:31
